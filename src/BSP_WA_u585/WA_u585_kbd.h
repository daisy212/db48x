...
#define KB_SCRUT_PERIOD    (5)

// key ok after x scrutation, anti rebound 
#define KB_PRESS_COUNT     (3)
#define KB_RELEASE_COUNT     (4)
...
#define ROW_A_Pin          GPIO_PIN_8
#define ROW_A_GPIO_Port    GPIOA
#define ROW_B_Pin          GPIO_PIN_9
#define ROW_B_GPIO_Port    GPIOA
#define ROW_C_Pin          GPIO_PIN_5
#define ROW_C_GPIO_Port    GPIOB
#define ROW_D_Pin          GPIO_PIN_0
#define ROW_D_GPIO_Port    GPIOB
#define ROW_E_Pin          GPIO_PIN_1
#define ROW_E_GPIO_Port    GPIOB
#define ROW_F_Pin          GPIO_PIN_7     
#define ROW_F_GPIO_Port    GPIOB
#define ROW_G_Pin          GPIO_PIN_6
#define ROW_G_GPIO_Port    GPIOB
#define ROW_H_Pin          GPIO_PIN_4
#define ROW_H_GPIO_Port    GPIOB
#define ROW_I_Pin          GPIO_PIN_3
#define ROW_I_GPIO_Port    GPIOB
...
typedef struct {
   uint32_t       key_press_time[KB_MAX_KEY];
   uint32_t       key_release_time[KB_MAX_KEY];
