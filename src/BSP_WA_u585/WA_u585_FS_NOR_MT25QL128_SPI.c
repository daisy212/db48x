...
//    PeriphClkInit.Spi1ClockSelection = RCC_SPI1CLKSOURCE_SYSCLK;     // 160Mhz
   PeriphClkInit.Spi1ClockSelection = RCC_SPI1CLKSOURCE_MSIK;
    ...
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = SPI_GPIO_AF;
    HAL_GPIO_Init(SPI_GPIO_PORT, &GPIO_InitStruct);
...
// datasheet = 32Mhz en faible consommation, 80Mhz, en pratique 5Mhz et encore !!!
// ok with flash identicication !
// + enter_leave_region
// + _init_spi only if necessary
// msik 24mhz div 16 : ll format check : 7.5sec
// msik 24mhz div 8 : ll format check : 4.1sec
// msik 24mhz div 4 : ll format check : 2.5sec
// msik 24mhz div 2 : ll format check : 1.7sec
    hSPI.Init.BaudRatePrescaler = SPI_BAUDRATEPRESCALER_4; // Adjust as needed
