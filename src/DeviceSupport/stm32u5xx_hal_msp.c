...
/**
  ...
  * @retval None
  */
void HAL_I2C_MspInitnotused(I2C_HandleTypeDef* hi2c)
{
...
/**
  ...
  * @retval None
  */
void HAL_I2C_MspDeInitnotused(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C1)
  {
...
/**
  ...
  * @retval None
  */
void HAL_LPTIM_MspInitnotused(LPTIM_HandleTypeDef* hlptim)
{
  RCC_PeriphCLKInitTypeDef PeriphClkInit = {0};
...
/**
  ...
  * @retval None
  */
void HAL_LPTIM_MspDeInitnotused(LPTIM_HandleTypeDef* hlptim)
{
  if(hlptim->Instance==LPTIM2)
  {
...
/**
  ...
  * @retval None
  */
void HAL_OSPI_MspInitnotused(OSPI_HandleTypeDef* hospi)
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  RCC_PeriphCLKInitTypeDef PeriphClkInit = {0};
  ...
  */
    ...
    PeriphClkInit.OspiClockSelection = RCC_OSPICLKSOURCE_SYSCLK;     // ok
...
/**
  ...
  * @retval None
  */
void HAL_OSPI_MspDeInitnotused(OSPI_HandleTypeDef* hospi)
{
  if(hospi->Instance==OCTOSPI1)
  {
    ...
    PB1     ------> OCTOSPIM_P1_IO0
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_6|GPIO_PIN_7);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  if(hspi->Instance==SPI1)
  {
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_5| GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7);
...
/**
  ...
  * @retval None
  */
void HAL_PCD_MspInit_notused(PCD_HandleTypeDef* hpcd)
{
  GPIO_InitTypeDef GPIO_InitStruct = {0};
  RCC_PeriphCLKInitTypeDef PeriphClkInit = {0};
