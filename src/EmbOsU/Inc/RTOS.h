...
#elif ((((defined __ARM_ARCH_7M__) || (defined __ARM_ARCH_7EM__)) && (USE_ERRATUM_837070 == 0)) || (defined __ARM_ARCH_8M_MAIN__) || (defined __ARM_ARCH_8_1M_MAIN__))
  //
  // Cortex-M3/M4[F]/M7[F] without workaround, Cortex-M33[F], Cortex-M55[F]/M85[F]
  //
...
#elif (((defined __ARM_ARCH_7M__) || (defined __ARM_ARCH_7EM__)) && (USE_ERRATUM_837070 == 1))
  //
  // Cortex-M3/M4[F]/M7[F] with workaround
  //
...
#else
  #error "Please check that __ARM_ARCH_6M__, __ARM_ARCH_7M__, __ARM_ARCH_7EM__, __ARM_ARCH_8M_BASE__, __ARM_ARCH_8M_MAIN__ or __ARM_ARCH_8_1M_MAIN__ is defined!"
#endif
...
*       OS_REGS
*
*  Register structure on task stack.
*  Used to initialize the task stack and also a debugging help.
*/
typedef struct {
  OS_U32 OS_REG_S0;
  OS_U32 OS_REG_S1;
...
void OS_TLS_Set                    (void) OS_TEXT_SECTION_ATTRIBUTE(OS_TLS_Set);
void OS_TLS_SetTaskContextExtension(void) OS_TEXT_SECTION_ATTRIBUTE(OS_TLS_SetTaskContextExtension);
//
...
/*********************************************************************
*
*       Support for SEGGER Stack Overflow Prevention
*/
extern const struct OS_EXTEND_TASK_CONTEXT_STRUCT OS_STOP_ContextExtension;
void OS_STOP_Set                    (OS_U32 StackLimit) OS_TEXT_SECTION_ATTRIBUTE(OS_STOP_Set);
void OS_STOP_SetTaskContextExtension(OS_U32 StackLimit) OS_TEXT_SECTION_ATTRIBUTE(OS_STOP_SetTaskContextExtension);
...
#define OS_VERSION_GENERIC  52000u
...
//
// Support for embOS compatibility mode (delays and timer periods aligned to full milliseconds)
//
#ifndef   OS_SUPPORT_ALIGNED_TIMEOUTS
  #define OS_SUPPORT_ALIGNED_TIMEOUTS       (0)
#endif
//
...
#define OS_TRACE_ID_MULTIOBJ_WAIT                    (340u)
#define OS_TRACE_ID_MULTIOBJ_WAIT_BLOCKED            (341u)
#define OS_TRACE_ID_MULTIOBJ_WAIT_TIMED              (342u)
#define OS_TRACE_ID_QUEUE_HASFREESPACE               (343u)
#define OS_TRACE_ID_TASK_DELAY_NS                    (344u)
#define OS_TRACE_ID_TASK_DELAYUNTIL_NS               (345u)
#define OS_TRACE_ID_TIME_GET_NS                      (346u)
#define OS_TRACE_ID_TIMER_CREATE_NS                  (347u)
#define OS_TRACE_ID_TIMER_GETPERIOD_NS               (348u)
#define OS_TRACE_ID_TIMER_GETREM_NS                  (349u)
#define OS_TRACE_ID_TIMER_SETPERIOD_NS               (350u)
#define OS_TRACE_ID_TIMER_CREATEEX_NS                (351u)
//
...
#define OS_MPU_ExtendContext  OS_MPU_ContextExtension
  ...
  #define OS_MPU_ASSERT_PRIVSTATE()  { OS_MPU_THREAD_STATE ThreadState;                                          \
                                                                                                                 \
                                       ThreadState = OS_MPU_GetPrivilegedState();                                \
...
void                    OS_TASK_Delay_ns                  (OS_U32 ns)                                                                                                                                                                            OS_TEXT_SECTION_ATTRIBUTE(OS_TASK_Delay_ns);
...
void                    OS_TASK_DelayUntil_ns             (OS_TIME ns)                                                                                                                                                                           OS_TEXT_SECTION_ATTRIBUTE(OS_TASK_DelayUntil_ns);
...
void      OS_TIMER_Create_ns                     (OS_TIMER* pTimer, OS_ROUTINE_VOID* pfTimerRoutine, OS_U32 ns)     OS_TEXT_SECTION_ATTRIBUTE(OS_TIMER_Create_ns);
...
OS_U64    OS_TIMER_GetPeriod_ns                  (OS_CONST_PTR OS_TIMER* pTimer)                                    OS_TEXT_SECTION_ATTRIBUTE(OS_TIMER_GetPeriod_ns);
...
OS_U64    OS_TIMER_GetRemainingPeriod_ns         (OS_CONST_PTR OS_TIMER* pTimer)                                    OS_TEXT_SECTION_ATTRIBUTE(OS_TIMER_GetRemainingPeriod_ns);
...
#else
#define   OS_TIMER_SetPeriod(pTimer, ms)         OS_TIMER_SetPeriod_ms(pTimer, ms)
#endif // OS_SUPPORT_ALIGNED_TIMEOUTS
...
void      OS_TIMER_SetPeriod_ns                  (OS_TIMER* pTimer, OS_U32 ns)                                      OS_TEXT_SECTION_ATTRIBUTE(OS_TIMER_SetPeriod_ns);
...
void    OS_TIMER_CreateEx_ns                             (OS_TIMER_EX* pTimerEx, OS_ROUTINE_VOID_PTR* pfTimerRoutine, OS_U32 ns,     void* pData) OS_TEXT_SECTION_ATTRIBUTE(OS_TIMER_CreateEx_ns);
...
#define OS_TIMER_GetPeriodEx_ns(pTimerEx)                OS_TIMER_GetPeriod_ns(&(pTimerEx)->Timer)
...
#define OS_TIMER_GetRemainingPeriodEx_ns(pTimerEx)       OS_TIMER_GetRemainingPeriod_ns(&(pTimerEx)->Timer)
...
#define OS_TIMER_SetPeriodEx_ns(pTimerEx,ns)             OS_TIMER_SetPeriod_ns(&(pTimerEx)->Timer, (ns))
...
char    OS_MAILBOX_GetTimed        (OS_MAILBOX* pMailbox, void* pMessage, OS_U32 Timeout)                     OS_TEXT_SECTION_ATTRIBUTE(OS_MAILBOX_GetTimed);
char    OS_MAILBOX_GetTimed1       (OS_MAILBOX* pMailbox, char* pMessage, OS_U32 Timeout)                     OS_TEXT_SECTION_ATTRIBUTE(OS_MAILBOX_GetTimed1);
...
OS_BOOL OS_MAILBOX_PutTimed        (OS_MAILBOX* pMailbox, OS_CONST_PTR void* pMessage, OS_U32 Timeout)        OS_TEXT_SECTION_ATTRIBUTE(OS_MAILBOX_PutTimed);
OS_BOOL OS_MAILBOX_PutTimed1       (OS_MAILBOX* pMailbox, OS_CONST_PTR char* pMessage, OS_U32 Timeout)        OS_TEXT_SECTION_ATTRIBUTE(OS_MAILBOX_PutTimed1);
void    OS_MAILBOX_WaitBlocked     (OS_MAILBOX* pMailbox)                                                     OS_TEXT_SECTION_ATTRIBUTE(OS_MAILBOX_WaitBlocked);
char    OS_MAILBOX_WaitTimed       (OS_MAILBOX* pMailbox, OS_U32 Timeout)                                     OS_TEXT_SECTION_ATTRIBUTE(OS_MAILBOX_WaitTimed);
...
int     OS_QUEUE_GetPtrTimed   (OS_QUEUE* pQ, void** ppMessage, OS_U32 Timeout)                                                 OS_TEXT_SECTION_ATTRIBUTE(OS_QUEUE_GetPtrTimed);
...
char    OS_QUEUE_PutTimed      (OS_QUEUE* pQ, OS_CONST_PTR void* pMessage, OS_UINT Size, OS_U32 Timeout)                        OS_TEXT_SECTION_ATTRIBUTE(OS_QUEUE_PutTimed);
char    OS_QUEUE_PutTimedEx    (OS_QUEUE* pQ, OS_CONST_PTR OS_QUEUE_SRCLIST* pMessageList, OS_UINT NumMessages, OS_U32 Timeout) OS_TEXT_SECTION_ATTRIBUTE(OS_QUEUE_PutTimedEx);
...
OS_INT OS_MULTIOBJ_WaitTimed  (OS_MULTIOBJ* pMultiObj, OS_CONST_PTR OS_MULTIOBJ_COND* pMultiObjCond, OS_UINT NumObjects, OS_U32 Timeout) OS_TEXT_SECTION_ATTRIBUTE(OS_MULTIOBJ_WaitTimed);
...
OS_U64  OS_TIME_Get_ns          (void)                              OS_TEXT_SECTION_ATTRIBUTE(OS_TIME_Get_ns);
...
#define OS_TIME_Get_us64                    OS_TIME_Get_us
