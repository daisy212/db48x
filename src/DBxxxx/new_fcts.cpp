...
// déclaration dans ids.tbl
// NAMED(testnfct, "Fct1")
// CMD(BL_increase)


// déclaration dans command.h
// COMMAND_DECLARE(BL_increase,-1);   
COMMAND_BODY(BL_increase){
   return OK;
}

COMMAND_BODY(BL_decrease){
   return OK;
}

// déclaration dans functions.h
